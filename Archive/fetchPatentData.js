...
const patentNumbers = [
  'US8163723',
  'US9242986',
  // {patentNumber: 'US8163723', drugName: '....'},
];
...
async function process() {
  try {
    ...
    const apiCalls = patentNumbers.map(patentNumber => makeApiCall(patentNumber, authToken));
    
    await Promise.all(apiCalls);
    return 'All API calls completed successfully';
  } catch (error) {
